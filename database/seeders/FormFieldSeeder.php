...
class FormFieldSeeder extends Seeder
{
   ...
   public function run(): void
   {
      ...
      $this->saveForm('Surat Keterangan Domisili', [
         ...
         $this->createField('NIK', 'nik', 'number', '16 digit NIK', false, null, 'required|digits:16'),
         ...
         $this->createField('RT', 'rt', 'number', '001', false, null, 'required|numeric'),
         $this->createField('RW', 'rw', 'number', '001', false, null, 'required|numeric'),
      ...
      $this->saveForm('Surat Keterangan Tidak Mampu', [
         ...
         $this->createField('Penghasilan', 'penghasilan', 'number', 'Contoh: 1500000', false, null, 'required|numeric'),
      ...
      $this->saveForm('Surat Keterangan Usaha', [
         ...
         $this->createField('NIK Pemilik', 'nik', 'number', '16 digit NIK', false, null, 'required|digits:16'),
         ...
         $this->createField('Lama Usaha (Thn)', 'lama_usaha', 'number', 'Contoh: 2', false, null, 'required|numeric'),
      ...
      $this->saveForm('Surat Keterangan Kematian', [
         ...
         $this->createField('NIK Almarhum', 'nik_almarhum', 'number', 'NIK (opsional)', false, null, 'required|digits:16'),
      ...
      $this->saveForm('Surat Keterangan Pindah', [
         ...
         $this->createField('NIK', 'nik', 'number', '', false, null, 'required|digits:16'),
         $this->createField('Alasan Pindah', 'alasan', 'input', 'Misal: Pekerjaan'),
         $this->createField('Tanggal Pindah', 'tanggal_pindah', 'date'),
         $this->createField('Jml Pengikut', 'jumlah_pengikut', 'number', 'Jml klg yang ikut', false, null, 'required|numeric'),
      ...
      $this->saveForm('Surat Keterangan Kelahiran', [
         ...
         $this->createField('Tempat Lahir', 'tempat_lahir', 'input'),
         $this->createField('Tanggal Lahir', 'tanggal_lahir', 'date'),
         $this->createField('Anak Ke-', 'anak_ke', 'number', '', false, null, 'required|numeric'),
      ...
      $this->saveForm('Surat Keterangan Penghasilan', [
         $this->createField('Nama Lengkap', 'nama_lengkap', 'input'),
         $this->createField('Pekerjaan', 'pekerjaan', 'input'),
         $this->createField('Jml Penghasilan', 'gaji', 'number', 'Contoh: 5000000', false, null, 'required|numeric'),
      ...
      $this->saveForm('Surat Keterangan Domisili Usaha', [
         ...
         $this->createField('Lama Beroperasi', 'lama_usaha', 'number', 'Contoh: 2 Tahun', false, null, 'required|numeric'),
      ...
      $this->saveForm('Surat Keterangan Ahli Waris', [
         ...
         $this->createField('NIK Pewaris', 'nik_pewaris', 'number', 'Opsional', false, null, 'required|digits:16'),
      ...
      $this->saveForm('Surat Keterangan Izin Keramaian', [
         ...
         $this->createField('NIK Penyelenggara', 'nik', 'number', '', false, null, 'required|digits:16'),
    ...
    */
   private function createField($label, $name, $type, $placeholder = '', $isFull = false, $options = null, $rules = 'required')
   {
      $dataType = 'string';
      ...
      return [
         ...
         'is_required'      => str_contains($rules, 'required'),
