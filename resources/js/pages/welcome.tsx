...
function GlowCard({
    ...
    return (
        <div
            className="group relative overflow-hidden rounded-2xl border border-gray-200/60 bg-white p-5 transition-all duration-300 hover:-translate-y-1 dark:border-gray-700/60 dark:bg-gray-800/80"
            onMouseMove={(e) => {
                ...
                <main className="flex flex-1 items-center">
                    <div className="relative w-full overflow-hidden">
                        ...
                        <div className="mx-auto max-w-7xl px-5 py-12 lg:py-16">
                                    ...
                                    <div className="relative w-full max-w-sm">
                                        ...
                                        <div className="relative z-10 overflow-hidden rounded-2xl border border-gray-200/80 bg-white shadow-2xl shadow-emerald-900/8 dark:border-gray-700/60 dark:bg-gray-800/90">
                                            ...
                                            <div className="flex items-center gap-3 border-b border-gray-200/80 bg-gray-50/80 px-4 py-3 dark:border-gray-700/60 dark:bg-gray-900/50">
                                                ...
                                                <div className="flex-1 rounded-md bg-gray-200/70 px-3 py-1 text-center dark:bg-gray-700/50">
                                                    <span className="text-[10px] font-medium text-gray-400 dark:text-gray-500">sureka.id/surat/SKD-001</span>
                                                </div>
                                            </div>
                            ...
                            {/* Social proof — Bento cards full-width */}
